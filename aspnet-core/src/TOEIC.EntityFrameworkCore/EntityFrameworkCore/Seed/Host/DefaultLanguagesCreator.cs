...
namespace TOEIC.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = TOEICConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(TOEICDbContext context)
    {
        _context = context;
    }
