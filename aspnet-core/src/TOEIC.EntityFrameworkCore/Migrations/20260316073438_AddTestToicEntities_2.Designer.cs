...
namespace TOEIC.Migrations
{
    ...
    [Migration("20260316073438_AddTestToicEntities_2")]
    partial class AddTestToicEntities_2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TOEIC.AppEntities.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TOEIC.AppEntities.ExamResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppExamResults");
                });

            modelBuilder.Entity("TOEIC.AppEntities.Passage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppPassages");
                });

            modelBuilder.Entity("TOEIC.AppEntities.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TOEIC.AppEntities.StudentAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TOEIC.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TOEIC.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TOEIC.AppEntities.ExamResult", b =>
                {
                    b.HasOne("TOEIC.AppEntities.Exam", "Exam")
                        .WithMany("ExamResults")
                        .HasForeignKey("ExamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TOEIC.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TOEIC.AppEntities.Question", b =>
                {
                    ...
                    b.HasOne("TOEIC.AppEntities.Passage", "Passage")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("TOEIC.AppEntities.StudentAnswer", b =>
                {
                    b.HasOne("TOEIC.AppEntities.ExamResult", "ExamResult")
                        .WithMany("StudentAnswers")
                        .HasForeignKey("ExamResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TOEIC.AppEntities.Question", "Question")
                        .WithMany()
