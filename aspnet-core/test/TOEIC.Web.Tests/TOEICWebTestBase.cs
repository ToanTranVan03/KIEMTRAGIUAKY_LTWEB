...
using TOEIC.Models.TokenAuth;
using TOEIC.Web.Startup;
...
namespace TOEIC.Web.Tests;

public abstract class TOEICWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static TOEICWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(TOEICWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<TOEICDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<TOEICDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<TOEICDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<TOEICDbContext, Task<T>> func)
    {
        T result;
